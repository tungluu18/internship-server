...
(4, 3, 'Tuyển lập trình viên embedded', 'Lương 2 củ 1 tháng', 'Lương 2 củ 1 tháng', '1528512444909', '1529254800000');
...
INSERT INTO `message` (`messageId`, `senderId`, `receiverId`, `replyTo`, `content`, `checked`) VALUES
(1, 2, 6, NULL, 'Chào bạn nha!', 0),
(2, 2, 6, NULL, 'Bye bạn nha!', 0);
